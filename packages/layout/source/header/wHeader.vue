<template lang="pug">
  header.w-header(:class="classCss")
    slot
</template>
...
<script lang="ts" setup>
  ...
  // Create the class name based on the defined layout blocks.
  const classCss: ComputedRef<string> = computed(getBlockAreaClass.bind(null, 'header'));
</script>
